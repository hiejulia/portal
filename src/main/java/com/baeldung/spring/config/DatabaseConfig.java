...
public class DatabaseConfig extends WebMvcConfigurerAdapter {
	...
	public DataSource dataSource() {
		...
		dataSource.setDriverClassName(env.getProperty("db.driver"));// driver 
		dataSource.setUrl(env.getProperty("db.url"));// url
		dataSource.setUsername(env.getProperty("db.username"));// username 
		dataSource.setPassword(env.getProperty("db.password"));// password 
		return dataSource;// return datasource //
	}

	// url based view resource 
	@Bean
